                        ...
                        <div className="mt-6 flex items-center gap-x-6">
                            <div className='flex gap-x-6'>
                                <input
                                    ...
                                    name="email"
                                    id="email"
                                    className="block w-full rounded-md border-0 px-5 py-5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
